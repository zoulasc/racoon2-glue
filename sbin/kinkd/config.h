...
/* Define to 1 if you have the `krb5_get_kdc_sec_offset' function. */
#define HAVE_KRB5_GET_KDC_SEC_OFFSET 1

/* Define to 1 if you have the `krb5_get_max_time_skew' function. */
...
/* Have the DES library */
/* #undef HAVE_LIBDES */

/* Define to 1 if you have the `hx509' library (-lhx509). */
/* #undef HAVE_LIBHX509 */
...
/* Have RFC3962 compliant AES support */
#define HAVE_RFC3962_AES 1
